...
public class Account {
	private long id;
	private double amount; // конструктор без параметров

	public Account() { // наличие этого конструктора некорректно по смыслу
						// класса
		super(); /*
	...
	public void setId(long id) { // проверка на корректность
		this.id = id;
	}

	public void addAmount(double amount) {
		/* данный метод в общем случае можно объявлять в другом классе */ this.amount += amount;
	}
}